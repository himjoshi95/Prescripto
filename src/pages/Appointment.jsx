...
const Appointment = () => {
    ...
    //Get available slots of paticular doctor
    const getAvailabaleSlots = async () => {
        ...
        for (let i = 0; i < 7; i++){
            ...
            let timeSlots= []
            //creating slot in every 30 minute interval
        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    {/* Doctor ifo: name,degree,experience */}
                    ...
                    <div className='flex items-center gap-2 text-ms mt-1 text-gray-600'>
                        ...
                        <button className='border border-gray-400 px-2 py-0.5 rounded-full'>{docInfo.experience}</button>
                    </div>
                    {/* Doctor About */}
                    <div>
